...
CHECKPOINT_PATH = {
    'all': {
        1: os.path.join(PROJECT_PATH, "mymodel/edges2.h5"),
...
class gRNAde(object):
    ...
    def __init__(
        ...
        print(f"Instantiating my_trained_model v{self.version}\n")
        ...
        print(f"Finished initialising my_trained_model v{self.version}\n")
    ...
    def design(
        ...
        sequences = [
            ...
            SeqRecord(
                ...
                id=f"input_sequence,",
                description=f"my_trained_model_v{self.version}, model={self.model.__class__.__name__}, max_num_conformers={self.max_num_conformers}, checkpoint={self.model_path}, seed={seed}"
            )
        ]
