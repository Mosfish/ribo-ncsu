...
    def forward(self, s):
        # s 形状: [bsz, seq_len, embed_dim]
        # V4 是自注意力，所以 query, key, value 都是 s
        # nn.MultiheadAttention 内部会自动处理 q, k, v 的投影。
        # attn_output 形状: [bsz, seq_len, embed_dim]
...
            dropout=drop_rate)
    ...
    def forward(self, x, edge_index, edge_attr):
        ...
        s_short_out = self.short_range_attn(s_reshaped, edge_index) #  [confs, nodes, dim]
